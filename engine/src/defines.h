...
#define KZ_PLATFORM_ANDROID 1
#elif defined(__unix__)
#define KZ_PLATFORM_UNIX 1
#elif defined(_POSIX_VERSION)
#define KZ_PLATFORM_POSIX 1
#elif __APPLE__
#define KZ_PLATFORM_APPLE 1
#include <TargetConditionals.h>
#if TARGET_IPHONE_SIMULATOR
#define KZ_PLATFORM_IOS 1
#define KZ_PLATFORM_IOS_SIMULATOR 1
...
#ifdef KZEXPORT
#ifdef _MSC_VER
#define KENZINE_API __declspec(dllexport)
#else
#define KENZINE_API __attribute__((visibility("default")))
#endif
#else
#ifdef _MSC_VER
#define KENZINE_API __declspec(dllimport)
#else
#define KENZINE_API
#endif
#endif
